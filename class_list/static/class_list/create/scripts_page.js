...
function createNewClass() {
    ...
    parameters = {
        ...
        'parameter': 'CREATE_SINGLE', // create single instance of class
    ...
    $.ajax({
        ...
        success: function (data) { 
            window.location.href = `${data.return_link}?jump_to=${data.class_id}`;
        }
    })
}
...
function customerKeyboardSelect(e) {
    function handleKeypress(keyCode) {
        ...
        var containsHighlighted = false; // highlighted student in list
            var i;
