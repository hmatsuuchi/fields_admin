...
function module001(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-001', '');
...
function lineGraph001(targetContainer, data) {
    ...
    let startDate = `${data.labels[0].slice(5, 7)}月${data.labels[0].slice(8, 10)}日`;
    let endDate = `${data.labels[data.labels.length - 1].slice(5, 7)}月${data.labels[data.labels.length - 1].slice(8, 10)}日`;
    ...
    const myChart = new Chart(ctx, {
        ...
        data: {
            ...
            },
            {
                ...
                data: data.pending,
                backgroundColor: [
                    'rgba(255, 222, 125, 0.4)',
                ],
                borderColor: [
                    'rgba(255, 222, 125, 0.8)',
                ],
                borderWidth: 1,
                radius: 4,
            },
...
function module002(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-002', '');
    modulesContainer.appendChild(primaryContainer);
...
function donutChart001(targetContainer, data) {
    let totalRecords = data.presentCount + data.absentCount + data.incompleteCount;
    let presentPercentage = Math.round(data.presentCount / totalRecords * 1000)/10;
    let absentPercentage = Math.round(data.absentCount / totalRecords * 1000)/10;
    let incompletePercentage = Math.round(data.incompleteCount / totalRecords * 1000)/10;
    ...
    let presentData = generateNewElement('div', 'attendance-data-item', '', `${data.presentCount}件<br>(${presentPercentage}%)`);
    presentData.classList.add('present-count');
    dataContainer.appendChild(presentData);

    let absentData = generateNewElement('div', 'attendance-data-item', '', `${data.absentCount}件<br>(${absentPercentage}%)`);
    absentData.classList.add('absent-count');
    dataContainer.appendChild(absentData);

    let incompleteData = generateNewElement('div', 'attendance-data-item', '', `${data.incompleteCount}件<br>(${incompletePercentage}%)`);
...
function module003(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-003', '');
    modulesContainer.appendChild(primaryContainer);
...
function module004(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-004', '');
    modulesContainer.appendChild(primaryContainer);
...
function module005(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-005', '');
    modulesContainer.appendChild(primaryContainer);
...
function module006(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-006', '');
    modulesContainer.appendChild(primaryContainer);
...
function lineGraph006(targetContainer, data) {
    ...
    let startDate = `${data.labels[0].slice(2,4)}年${data.labels[0].slice(5, 7)}月`;
    let endDate = `${data.labels[0].slice(2,4)}年${data.labels[data.labels.length - 1].slice(5, 7)}月`;
...
function module007(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-007', '');
    modulesContainer.appendChild(primaryContainer);
...
function module008(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-008', '');
    modulesContainer.appendChild(primaryContainer);
...
function module009(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-009', '');
    modulesContainer.appendChild(primaryContainer);
...
function barGraph009(targetContainer, data) {
    ...
    let subtitle = generateNewElement('div', 'subtitle', '', '');
    subtitle.innerHTML += `${startDate.slice(0,2)}年${startDate.slice(3,5)}月 ~ ${endDate.slice(0,2)}年${endDate.slice(3,5)}月`;
    titleContainer.appendChild(subtitle);
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            ...
                            if (label) {
                                // console.log(context);
                                let groupPercentage = Math.round(context.parsed.y/data.totals[context.dataIndex]*100);
                                label += `: ${context.parsed.y}人 / 計: ${data.totals[context.dataIndex]}人 (${groupPercentage}%)`;
                            }
...
function module010(startDate, endDate) {
    ...
    // PRIMARY CONTAINER
    let primaryContainer = generateNewElement('div', 'module-primary-container', 'module-010', '');
    modulesContainer.appendChild(primaryContainer);
...
function lineGraph010(targetContainer, data) {
    ...
    let endDate = `${data.year[data.year.length - 1].slice(2,4)}年${data.month[data.month.length - 1]}月`;
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            ...
                            if (label) {
                                label += `: ${context.parsed.y}`.slice(0,6) + ` (${data.studentCount[context.dataIndex]}人)`;
                            }
